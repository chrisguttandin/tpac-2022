    ...
    return {
        ...
        'lint-src': {
            cmd: `htmlhint --config config/htmlhint/document.json 'src/**/index.html' && \
                ...
                npx ng lint tpac-2022 && \
                npx stylelint 'src/**/*.scss' --config config/stylelint/config.json`
        },
        'lint-test': {
            cmd: 'npx ng lint tpac-2022 --configuration test'
        },
        'monitor': {
            cmd: 'npx ng serve'
        },
        ...
        'smoke': {
            cmd: `npx playwright install --with-deps && \
                ...
                npx hint --telemetry=off https://chrisguttandin.github.io/tpac-2022`
        },
        'test': {
            cmd: 'npx ng test --watch false'
        },
        'verify': {
            cmd: `npx bundle-buddy build/tpac-2022/*.js.map && \
