...
export default defineConfig([
    ...
    },
    {
        files: ['**/*.ts'],
        rules: {
            '@angular-eslint/component-selector': ['error', { prefix: 'tpc', style: 'kebab-case', type: 'element' }],
            '@angular-eslint/directive-selector': ['error', { prefix: 'tpc', style: 'camelCase', type: 'attribute' }],
